...
public class ViewCourseAnalytics extends AppCompatActivity implements OnChartValueSelectedListener{
    ...
    private void setUpLineChart(){
        ...
        d.setText("Student Attendance");
        e.setText("");
        lineChart.setOnChartValueSelectedListener(this);

        // descriptive text to explain to the user why there is no chart available
        lineChart.setNoDataText("No Student Attendance Data Available.");

        // descriptive text that appears in the bottom right corner of the chart1
    ...
    public void onValueSelected(Entry e, int dataSetIndex) {
        ...
        if(dataSetIndex == data.getIndexOfDataSet(dataset)){
            String message = "Attendance is: " + e.getData().toString() + " on " + dateSelected.toString();
            Toast.makeText(this, message, Toast.LENGTH_LONG).show();

        }

        else{
            String message = "Late arrivals are: " + e.getData().toString() + " on " + dateSelected.toString();
            Toast.makeText(this, message, Toast.LENGTH_LONG).show();
        }
    }
