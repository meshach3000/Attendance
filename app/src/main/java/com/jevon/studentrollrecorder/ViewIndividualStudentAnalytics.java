...
public class ViewIndividualStudentAnalytics extends AppCompatActivity {
    ...
    public void updateAttendancePieChart(){
        ...
        PieDataSet dataset = new PieDataSet((List)entries,"Sessions");
        ...
        PieData dt = new PieData(dataset);
